...
// All Karat prices are derived by ratio from the 24K price:
//   price_per_gram_NK = (N / 24) × price_per_gram_24K
// GoldAPI already gives us 22K, 21K, and 18K directly.
// We calculate 9K and 1K ourselves.

function buildGoldPrices(data) {
  const p24 = data.price_gram_24k;
  return [
    { Karat: '22K', label: '22 Karat Gold',  purity: '91.67%', price: data.price_gram_22k ?? (22 / 24) * p24 },
    { Karat: '18K', label: '18 Karat Gold',  purity: '75%',    price: data.price_gram_18k ?? (18 / 24) * p24 },
    { Karat: '9K',  label: '9 Karat Gold',   purity: '37.5%',  price: (9  / 24) * p24 },
    { Karat: '1K',  label: '1 Karat Gold',   purity: '4.17%',  price: (1  / 24) * p24 },
    { Karat: '24K', label: '24 Karat (Pure)', purity: '100%',  price: p24, isPure: true },
  ];
}
...
function buildSilverPrices(data) {
  const p24 = data.price_gram_24k;
  return [
    { Karat: '22K', label: '22 Karat Silver', purity: '91.67%', price: (22 / 24) * p24 },
    { Karat: '24K', label: '24 Karat (Pure)',  purity: '100%',   price: p24, isPure: true },
  ];
}
